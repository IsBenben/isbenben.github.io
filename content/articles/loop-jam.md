...
![2^1024 Loops编程增量游戏代码操作说明示意图](https://isbenben.github.io/loop-jam-cn/textures/help.png)

单击"运行（Run）"按钮可以运行代码，一次运行成为一个"`loop`"。会实时展现当前运行状态，再按一次可以加速（Fast）运行一整轮代码。
...
![2^1024 Loops编程增量游戏主菜单截图](/raw/loop-jam-main-menu.png)

![2^1024 Loops编程增量游戏选择奖励界面截图](/raw/loop-jam-choosing-rewards.png)

![2^1024 Loops编程增量游戏成就界面截图](/raw/loop-jam-achivements.png)
