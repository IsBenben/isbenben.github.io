---
{
  "description":
    [
      ...
      "而Scratch不支持直接获取包含特殊表情字符的长度，或某个字符。",
      "本示例展示如何手动处理字符串，解决该问题。",
    ],
  "date": "2025/02/17",
  "tags":
    [
  ...
  "links":
    [
      [
        "https://github.com/IsBenben/Funny-Things/blob/main/UTF-16支持.sb3",
        "查看示例程序",
      ],
      ["https://www.bilibili.com/video/BV1iawdejEnG", "演示视频"],
    ],
  "downloads": [["/raw/utf-16-supporting.sb3", "下载示例程序"]],
  "hide": false,
}
---
...
![Scratch支持UTF-16解决方案截图](/raw/utf-16-supporting-solution.png)
